<%-- 
    Document   : ModifyRooms
    Created on : 27-Mar-2021, 22:34:59
    Author     : amals
--%>
    ...
    <body>
         ...
         <li style="float:right; margin-right:1px;"><img  src="3201525-200.png" width="55" height="55"></li>
          ...
          <%
              ...
              <br>
              <br>
               <input style="margin-left:40px;" type="button" value="Add new Room" name="AddRoom" onclick="location.href='AddRoom.jsp';" />
           <br>
              <br>
              <table style="margin-right:auto; margin-left:auto; background-color:white; width: 95%; border-collapse: collapse;" border="2" width="2">
                ...
                <tbody>
                      ...
                      <tr>
                          ...
                          <td><a href="AdminBeds.jsp?ID=<%=result.getInt("ID")%>">display</a></td>
                          <td><a href="updateRoomForm.jsp?ID=<%=result.getInt("ID")%>">Edit</a></td>
